...
@implementation PPXUILabel

+ (void)initialize
{
    if (self != PPXUILabel.class)
        return;
...
- (NSArray *)pxStyleChildren
{
    ...
    {
        __weak PPXUILabel *weakSelf = self;
...
- (NSArray *)viewStylers
{
    ...
    dispatch_once(&onceToken, ^{
        stylers = @[
            ...
            [[PXTextShadowStyler alloc] initWithCompletionBlock:^(PPXUILabel *view, PXTextShadowStyler *styler, PXStylerContext *context) {
            ...
            [[PXFontStyler alloc] initWithCompletionBlock:^(PPXUILabel *view, PXFontStyler *styler, PXStylerContext *context) {
                [view px_setFont:context.font];
            }],
            
            [[PXPaintStyler alloc] initWithCompletionBlock:^(PPXUILabel *view, PXPaintStyler *styler, PXStylerContext *context) {
            ...
            [[PXTextContentStyler alloc] initWithCompletionBlock:^(PPXUILabel *view, PXTextContentStyler *styler, PXStylerContext *context) {
                [view px_setText:context.text];
            }],
                
            [[PXGenericStyler alloc] initWithHandlers: @{
                 @"text-transform" : ^(PXDeclaration *declaration, PXStylerContext *context) {
                    PPXUILabel *view = (PPXUILabel *)context.styleable;
